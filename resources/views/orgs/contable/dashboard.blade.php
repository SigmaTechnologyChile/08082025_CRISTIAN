...
<body>
    ...
    <div class="container">
        <div class="card">
            ...
            <div class="btn-wrapper">
                <a href="{{ route('orgs.contable.ingresos', ['id' => $orgId]) }}" class="btn btn-primary">
                    <i class="bi bi-cash-coin"></i>
                    Registro de Ingresos
                </a>

                <a href="{{ route('orgs.contable.egresos', ['id' => $orgId]) }}" class="btn btn-primary">
                    <i class="bi bi-credit-card"></i>
                    Registro de Egresos
                </a>

                <a href="{{ route('orgs.contable.giros-depositos', ['id' => $orgId]) }}" class="btn btn-primary">
                    <i class="bi bi-arrow-left-right"></i>
                    Giros y Depósitos
                </a>

                <a href="{{ route('orgs.contable.libro-caja', ['id' => $orgId]) }}" class="btn btn-primary">
                    <i class="bi bi-journal-bookmark"></i>
                    Libro de Caja Tabular
                </a>

                <a href="{{ route('orgs.contable.balance', ['id' => $orgId]) }}" class="btn btn-primary">
                    <i class="bi bi-bar-chart"></i>
                    Balance
                </a>

                <a href="{{ route('orgs.contable.conciliacion', ['id' => $orgId]) }}" class="btn btn-primary">
                    <i class="bi bi-bank"></i>
                    Conciliación Bancaria
                </a>

                <a href="{{ route('orgs.contable.informe-rubro', ['id' => $orgId]) }}" class="btn btn-primary">
                    <i class="bi bi-pie-chart"></i>
                    Informe por Rubro
                </a>

                <a href="{{ route('orgs.contable.movimientos', ['id' => $orgId]) }}" class="btn btn-primary">
    ...
    <script>
        ...
        function actualizarEstadisticas() {
            fetch('{{ route("orgs.contable.dashboard.estadisticas", ["id" => $orgId]) }}')
