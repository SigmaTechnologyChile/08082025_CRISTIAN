        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            @if($user->isSuperAdmin() || $perfilId == 0)
                ...
                @if(Request::is('org/*'))
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ $active == 'orgs.locations.panelcontrolrutas' ? '' : 'collapsed' }}"
                            href="{{route('orgs.locations.panelcontrolrutas', ['id' => auth()->user()->org_id])}}">

                            <i class="bi bi-sign-merge-right" style="color: blue;"></i>

                            <span>Panel de Control Rutas</span>
